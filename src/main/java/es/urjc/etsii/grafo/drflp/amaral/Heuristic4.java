...
public class Heuristic4 extends AbstractAmaralHeuristic{
    private static final Logger log = Logger.getLogger(Heuristic4.class.getName());

    public Heuristic4(DRFLPGurobiAdapter gurobi, int time, TimeUnit unit) {
