...
public class DRFLPInstanceImporter extends InstanceImporter<DRFLPInstance> {

    Logger log = Logger.getLogger(DRFLPInstanceImporter.class.getName());
    ...
    public DRFLPInstance importInstance(BufferedReader reader, String filename) {
        ...
        var instance = new DRFLPInstance(instanceName, facilities, weights);
        return instance;
    }
